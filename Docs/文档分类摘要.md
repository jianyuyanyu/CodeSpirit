...
├── 03-Core-Components/             # 🔧 核心组件 (28个文件)
├── 04-Identity-Auth/               # 🔐 身份认证与权限 (4个文件)
...
### 🔧 03-Core-Components (28个文件)
**核心组件**：导航系统、数据处理、服务组件、AI智能填充、审计系统等
...
- CodeSpirit.Audit分布式审计完整指南.md ⭐ **新合并文档**
...
### 🔐 04-Identity-Auth (4个文件)
**身份认证与权限**：身份认证、权限管理、前端集成、权限继承机制
