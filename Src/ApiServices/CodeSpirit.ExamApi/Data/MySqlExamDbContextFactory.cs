...
/// 用于设计时工具（如迁移生成）
/// </summary>
public class MySqlExamDbContextFactory : IDesignTimeDbContextFactory<MySqlExamDbContext>
{
    /// <summary>
    /// 创建数据库上下文
    /// </summary>
    /// <param name="args">命令行参数</param>
    /// <returns>MySQL考试系统数据库上下文</returns>
    public MySqlExamDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<MySqlExamDbContext>();
