...
public class MySqlFileStorageDbContextFactory : IDesignTimeDbContextFactory<MySqlFileStorageDbContext>
{
    ...
    public MySqlFileStorageDbContext CreateDbContext(string[] args)
    {
        ...
        var connectionString = configuration.GetConnectionString("DefaultConnection") ?? "Server=localhost;Port=3306;Database=filestorage-api;Uid=root;Pwd=Password123;CharSet=utf8mb4;";
