        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownloadUrl = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    ETag = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CameraModel = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    DateTaken = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Latitude = table.Column<double>(type: "float", nullable: true),
                    Longitude = table.Column<double>(type: "float", nullable: true),
                    ExifData = table.Column<string>(type: "nvarchar(max)", nullable: false),
