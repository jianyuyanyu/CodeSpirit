...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeSpirit.FileStorageApi.Entities.ThumbnailEntity", b =>
                {
                    ...
                    b.Property<long>("ImageMetadataId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ImageMetadataId", "SizeKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("CodeSpirit.FileStorageApi.Entities.ThumbnailEntity", b =>
                {
                    b.HasOne("CodeSpirit.FileStorageApi.Entities.ImageMetadataEntity", "ImageMetadata")
                        .WithMany("Thumbnails")
                        .HasForeignKey("ImageMetadataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodeSpirit.FileStorageApi.Entities.FileEntity", "ThumbnailFile")
                        .WithMany()
