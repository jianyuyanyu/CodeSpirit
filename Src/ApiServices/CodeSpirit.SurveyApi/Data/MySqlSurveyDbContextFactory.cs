...
public class MySqlSurveyDbContextFactory : IDesignTimeDbContextFactory<MySqlSurveyDbContext>
{
    ...
    public MySqlSurveyDbContext CreateDbContext(string[] args)
    {
        ...
        var connectionString = configuration.GetConnectionString("DefaultConnection") ?? "Server=localhost;Port=3306;Database=survey-api;Uid=root;Pwd=Password123;CharSet=utf8mb4;";
