...
namespace CodeSpirit.SurveyApi.Migrations.SqlServer
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LLMRawOutput = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
                    IsPreviewChecked = table.Column<bool>(type: "bit", nullable: false),
                    PublicAccessCode = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    ShareExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
