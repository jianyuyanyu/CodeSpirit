(function () {
    ...
    const resultPage = {
        ...
        body: [
                ...
                body: [
                    {
                        ...
                        items: [
                            {
                                type: 'tpl',
                                tpl: '<div class="logo"><img src="' + (window.siteSettings ? window.siteSettings.logoUrl : '/logo.png') + '" /><span>' + (window.siteSettings ? window.siteSettings.clientAppName : '练习系统') +'</span></div>',
            ...
            {
                type: 'service',
                api: `/exam/api/client/practice/result/${recordId}`,
                ...
                body: [
                    {
                        ...
                        header: {
                            type: 'tpl',
                            tpl: '<div style="font-size: 24px; font-weight: bold; color: var(--primary-color); text-align: center;">${name} - 练习结果</div>',
                        ...
                        body: [
                            {
                                ...
                                items: [
                                    ...
                                    {
                                        type: 'tpl',
                                        tpl: '提交时间：${endTime | date:YYYY-MM-DD HH:mm:ss}',
                                        className: 'exam-info-item'
                                    },
                                    {
                                        type: 'tpl',
                                        tpl: '练习模式：${practiceMode === "Normal" ? "普通模式" : practiceMode === "RandomQuestion" ? "随机题目" : practiceMode === "Sequential" ? "顺序练习" : practiceMode}',
                                        className: 'exam-info-item'
                                    },
                                    {
                                        type: 'tpl',
                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    {
                                        type: 'tpl',
                                        tpl: '<div class="result-status ${score >= totalScore * 0.6 ? \'pass\' : \'fail\'}">${score >= totalScore * 0.6 ? \'通过\' : \'未通过\'}</div>',
                            ...
                            {
                                type: 'tpl',
                                tpl: '<div class="statistics-container"><div class="statistics-item"><span class="statistics-label">总题数：</span>${totalCount}题</div><div class="statistics-item"><span class="statistics-label">正确数：</span>${correctCount}题</div><div class="statistics-item"><span class="statistics-label">正确率：</span>${(correctCount / totalCount * 100).toFixed(2)}%</div></div>',
                                className: 'mt-3'
                            },
                            {
                                type: 'divider'
                                ...
                                body: [
                                    {
                                        ...
                                        items: {
                                            ...
                                            body: [
                                                ...
                                                {
                                                    type: 'tpl',
                                                    tpl: '<div class="time-spent">用时：${timeSpent}秒</div>',
                                                    className: 'mt-2'
                                                }
                                            ]
                                        }
