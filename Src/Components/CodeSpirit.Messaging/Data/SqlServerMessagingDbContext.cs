...
/// <summary>
/// SQL Server 特定的消息数据库上下文
/// 用于迁移和SQL Server特定的配置
/// </summary>
public class SqlServerMessagingDbContext : MessagingDbContext
{
    /// <summary>
    /// 构造函数
    /// </summary>
    ...
    public SqlServerMessagingDbContext(
        DbContextOptions<SqlServerMessagingDbContext> options,
