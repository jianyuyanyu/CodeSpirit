...
/// <summary>
/// SQL Server 特定的设置数据库上下文
/// 用于迁移和SQL Server特定的配置
/// </summary>
public class SqlServerSettingsDbContext : SettingsDbContext
{
    /// <summary>
    /// 构造函数
    /// </summary>
    ...
    public SqlServerSettingsDbContext(
        DbContextOptions<SqlServerSettingsDbContext> options,
