...
namespace CodeSpirit.Charts.Tests.Samples
{
    ...
    public class ChartsApiController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("sales")]
        public async Task<IActionResult> GetSalesChart([FromQuery] string chartType = "auto")
        {
            // 示例销售数据
            var salesData = new[]
            {
            ...
            {
                // 使用自动推荐的图表类型
                return await this.AutoChartResult(salesData);
            }
            ...
            return await this.AutoChartResult(salesData, type);
        }
        ...
        /// </summary>
        [HttpGet("performance")]
        public async Task<IActionResult> GetPerformanceChart([FromQuery] string chartType = "auto")
        {
            // 示例性能数据
            ...
            {
                // 使用自动推荐的图表类型
                return await this.AutoChartResult(performanceData);
            }
            ...
            return await this.AutoChartResult(performanceData, type);
        }
        ...
        public async Task<IActionResult> GetDistributionChart([FromQuery] string chartType = "auto")
        {
            // 示例分布数据
            ...
            return await this.AutoChartResult(distributionData, type);
        }
        ...
        /// </summary>
        [HttpGet("recommend")]
        public async Task<IActionResult> GetRecommendedChartTypes([FromQuery] string dataType, [FromQuery] int maxCount = 3)
        {
            object data;
            ...
            // 使用控制器扩展方法获取推荐的图表类型
            return await this.ChartRecommendations(data, maxCount);
        }
        ...
        //public async Task<IActionResult> GetEChartsConfig()
        //{
        //    // 示例数据
        //    var data = new[]
        //    {
        ...
        //    // 使用图表推荐器生成配置
        //    var config = await _recommender.GenerateChartConfig(data);
