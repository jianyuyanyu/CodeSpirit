...
![image-20251228144325806](/img/image-20251228144325806.png)
...
![image-20251228144458888](/img/image-20251228144458888.png)
...
4. 所有内容显示为英文
   ...
   ![image-20251228144624297](/img/image-20251228144624297.png)
...
![image-20251228144653246](/img/image-20251228144653246.png)

## 🧭 导航组件多语言

导航组件（`CodeSpirit.Navigation`）提供了完整的多语言支持，用于实现动态导航菜单的多语言切换。

![image-20251228145339114](/img/image-20251228145339114.png)
